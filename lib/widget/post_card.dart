...
import 'package:instragram_firebase/screens/comments_screen.dart';
import 'package:instragram_firebase/screens/profile_screen.dart';
import 'package:instragram_firebase/utils/colors.dart';
import 'package:instragram_firebase/utils/global_variable.dart';
import 'package:instragram_firebase/utils/utils.dart';
import 'package:instragram_firebase/widget/like_animation.dart';
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                widget.snap['uid'].toString() == widget.uid
                    ? IconButton(
                        onPressed: () {
                          showDialog(
